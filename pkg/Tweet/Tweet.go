...
func TweetCount() (*http.Response, error) {
	search_url := fmt.Sprintf("%v/tweets/counts/recent", internal.BaseURL)	
...
func FetchRetweets(id string) (*http.Response, error) {
	url := fmt.Sprintf("%s/tweets/%s/retweeted_by", internal.BaseURL, id)
...
func CountTweet() (*http.Response, error) {
	...
	url := fmt.Sprintf("%s/tweets/counts/recent", internal.BaseURL)
	httpRequest, err := http.NewRequest("GET", url, nil)
	if err != nil {
		return nil, err
	}
...
func FetchTweet(tweet_fields string, ids string) (*http.Response, error) {
	url := fmt.Sprintf("%s/tweets?%s&%s", internal.BaseURL, ids, tweet_fields) 
